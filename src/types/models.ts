...
export type Household = {
  ...
  owners?: string[]; // List of owners/people (e.g., ["Ranbir", "Sarah", "Joint"])
...
export type Account = {
  ...
  interestRate?: number;
  owner?: string; // Owner of the account (e.g., "Person 1", "Person 2", "Joint")
...
export type Cashflow = {
  ...
  owner?: string; // Owner of the income/expense (e.g., "Person 1", "Person 2", "Joint")
